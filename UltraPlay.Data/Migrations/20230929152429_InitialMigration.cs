    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchInformers", x => x.ID);
                    table.ForeignKey(
                        name: "FK_MatchInformers_Matches_EntityId",
                        column: x => x.EntityId,
                        principalTable: "Matches",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BetInformers", x => x.ID);
                    table.ForeignKey(
                        name: "FK_BetInformers_Bets_EntityId",
                        column: x => x.EntityId,
                        principalTable: "Bets",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OddInformers", x => x.ID);
                    table.ForeignKey(
                        name: "FK_OddInformers_Odds_EntityId",
                        column: x => x.EntityId,
                        principalTable: "Odds",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchInformers_EntityId",
                table: "MatchInformers",
                column: "EntityId");

            migrationBuilder.CreateIndex(
                name: "IX_OddInformers_EntityId",
                table: "OddInformers",
                column: "EntityId");
